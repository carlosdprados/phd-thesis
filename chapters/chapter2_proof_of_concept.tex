...
\begin{enumerate}
  ...
  \item \textbf{\STDP{}.} An asymmetric Hebbian STDP function was measured, with time constant \(\tau = \SIrange{85}{90}{\milli\second}\), within the biologically realistic range of \(\sim\SI{100}{\milli\second}\)~\cite{Bi1998, Kuzum2013}.
