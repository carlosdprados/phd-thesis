...
The resulting non-uniform ionic charge distribution modifies the internal electric field profile of the device significantly: the field is concentrated in a thin screening length near each electrode, while the bulk of the film is field-free. This spatial redistribution of field has significant consequences for charge injection, as described in the two competing models below.
