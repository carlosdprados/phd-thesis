...
All electrical measurements were performed with a Keithley 2450 SourceMeter in a custom probe station. Unless otherwise stated, measurements were made under nitrogen with voltage applied to the Ag top electrode relative to grounded ITO. Protocol-level details are given in \chTwoSIRef{app:ch2_electrical_protocols}.
