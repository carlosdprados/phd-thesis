...
Within the arc of the thesis, the present chapter is narrow in role. It is the only chapter in which the full synaptic suite (EPSC, separated short- and long-term retention, and STDP) is treated as the main evidence. The later chapters rely on a narrower set of measurements instead, shared across the whole comparative corpus. The two specific handoffs onto the rest of the thesis are taken up at the end of the chapter.
