...
The compositional ratios were arrived at through systematic optimisation~\cite{PradoSocorro2022}. Increasing the relative concentration of \LiTf{} beyond the chosen ratio was found to produce phase separation detectable by optical microscopy and a deterioration in film homogeneity. Conversely, reducing the salt content below the chosen ratio produced devices with insufficient ionic carrier density to generate well-defined conductance states. The chosen ratio represents a balance between maximising ionic carrier concentration and maintaining film morphological integrity.

This composite is identical in formulation to the active layer of the LECs studied by Mardegan \textit{et al.}~\cite{Mardegan2021}, where its electroluminescent performance and long operational lifetime (\SI{>1600}{\hour}) were established; the present work redeploys the same architecture for memristive operation.
...
The completed device was stored under nitrogen atmosphere until measurement. The devices were functional without encapsulation in ambient air for the duration of most experiments; degradation studies (\cref{sec:stability}) confirm a functional lifetime of approximately two weeks (\SI{300}{\hour}) under ambient conditions.
...
The resulting non-uniform ionic charge distribution modifies the internal electric field profile of the device significantly: the field is concentrated in a thin screening length near each electrode, while the bulk of the film is field-free~\cite{deMello1998,deMello2002}. This spatial redistribution of field has significant consequences for charge injection, as described in the two competing models below.
