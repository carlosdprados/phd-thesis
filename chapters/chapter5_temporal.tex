...
%% ------------------------------------------------------------
\section[Design Rule: Matching Timescale to Task]{Design Rule: Matching Timescale to Task --- Judging the Comparative-Chapter Findings Against the Application}\label{sec:ch4_designrules}
%% ------------------------------------------------------------
...
%% ------------------------------------------------------------
\section{Summary and Bridge to the Conclusions}\label{sec:ch4_conclusions}
%% ------------------------------------------------------------
