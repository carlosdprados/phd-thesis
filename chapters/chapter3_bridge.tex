...
\begin{table}[t]
  \centering
  \caption[Methods-of-elimination summary]{The degradation investigation as a method of elimination. Each candidate cause was crossed as a deliberate batch (device codes in the standard \texttt{NM\_v\textit{nnn}} naming) with its variables pinned in the provenance record; the verdict column gives the campaign's reading. The processing variables that were tested and excluded leave the consumable reagent stock --- specifically the hyperbranched \Hybrane{} host --- as the residual suspect, pursued quantitatively in \cref{sec:bridge_degradation}.}
...
\paragraph{Four controls, each shown to matter.} The degradation analysis is built on a methodological backbone of four controls; each was verified to change the conclusion if dropped.
\begin{enumerate}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/chapter3_bridge/bridge_window_collapse.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/chapter3_bridge/bridge_mechanism.pdf}
...
\paragraph{The hypothesis.} \Hybrane{} is a hyperbranched polyester-amide~\cite{Froehling2004,VoitLederer2009}: ester- and amide-rich, and strongly hygroscopic. The leading hypothesis is that, over roughly a year in the bottle, the stock takes up atmospheric water and slowly hydrolyses (chain scission), and that this single process accounts for all of the measured signatures.
\begin{itemize}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/chapter3_bridge/bridge_resolution.pdf}
...
%% ------------------------------------------------------------
\section{The Methodological Legacy Carried Forward}\label{sec:bridge_legacy}
%% ------------------------------------------------------------
...
%% ------------------------------------------------------------
\section{Reconciliation with Chapter~\texorpdfstring{\ref*{ch:poc}}{2} and Bridge to the Comparative Study}\label{sec:bridge_reconciliation}
%% ------------------------------------------------------------
