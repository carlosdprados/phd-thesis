...
%% ---- Front matter ----
\include{chapters/frontmatter_motivation}

%% ---- Chapters ----
\include{chapters/chapter1_introduction}
\include{chapters/chapter2_proof_of_concept}
\include{chapters/chapter3_bridge}
\include{chapters/chapter4_comparative}
\include{chapters/chapter5_temporal}
\include{chapters/chapter6_conclusions}

%% ---- Appendices (lettered A,B,C,D in include order) ----
\appendix
\include{chapters/appendix_chapter2_supporting_information}
\include{chapters/appendix_chapter3_bridge_SI}
\include{chapters/appendix_chapter4_comparative_SI}
\include{chapters/appendix_chapter5_temporal_SI}
