#!/usr/bin/env python3
"""Chapter 4 behavioural model — composition-indexed parameter cards + the
...
Run from the repo root:  python3 scripts/ch4_model.py
Inputs (produced by scripts/ch3_4_dynamics_fits.py):
  handouts/ch3_decay_by_cell.csv   -> fading memory tau, beta, t_half, retention60
  handouts/ch3_pulses_by_cell.csv  -> write nonlinearity alpha, peak ratio, N_peak, turnover

This is the SHARED BACKBONE for both Chapter-4 demonstrations (handout 12):
