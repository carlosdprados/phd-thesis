...
Eleven insertion points met the criteria. They are listed in reading order.
...
## Figure 10 — Organic memristor historical landscape
...
## Figure 11 — Two-terminal polymer-electrolyte composite architecture and the composition/cation timescale ladder
...
The following candidates were considered but not retained in the current eleven-figure plan:

- **HSAB periodic-table excerpt in §1.6.1.** The HSAB ordering is compact enough to carry in prose and is reused in Figure 11 (b) as a labelled axis; a dedicated periodic-table figure would duplicate material that the reader can already parse.
...
1. Commission or draft the eleven figures as vector graphics.
2. Assign filenames under `figures/chapter1/` at that point.
3. Insert `\begin{figure} ... \end{figure}` floats carrying the labels and captions above, positioned as specified. Three of the eleven (Figures 9, 10, 11) replace existing `% TODO:` comments at the ends of §1.4, §1.5, and §1.6; the remaining eight (Figures 1, 2, 3, 4, 5, 6, 7, 8) are fresh insertions in subsections that do not currently carry a TODO marker.
